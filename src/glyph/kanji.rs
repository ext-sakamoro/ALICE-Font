...
fn component_strokes(ch: char, b: Bbox) -> Vec<Stroke> {
    ...
    match ch {
        ...
        // ---- 第6バッチ: 観察された未定義部品 ---------------------------------
        // 朱: Noto 参照 (6 strokes)
        // 上点 / 短横 / 中央長横 / 縦線 / 左下払い / 右下払い
        '朱' => alloc::vec![
            // 1: 上の左上点 (短い斜め)
            Stroke::new(m(0.12, 0.92), m(0.18, 0.88), m(0.22, 0.85), m(0.28, 0.82)),
            // 2: 上の短横
            Stroke::line(m(0.2, 0.78), m(0.8, 0.78)),
            // 3: 中央の長横
            Stroke::line(m(0.05, 0.55), m(0.95, 0.55)),
            // 4: 中央縦線
            Stroke::line(m(0.5, 0.85), m(0.5, 0.05)),
            // 5: 左下払い
            Stroke::new(m(0.5, 0.5), m(0.38, 0.4), m(0.22, 0.25), m(0.05, 0.08)),
            // 6: 右下払い
            Stroke::new(m(0.5, 0.5), m(0.62, 0.4), m(0.78, 0.25), m(0.95, 0.08)),
        ],
        // 弋: Noto 参照 (3 strokes)
        // 横線、長い S 字状斜め、右上の小点
        '弋' => alloc::vec![
            // 1: 横線 (左下から右上に傾斜)
            Stroke::line(m(0.05, 0.65), m(0.85, 0.6)),
            // 2: 長い斜め (上から下へカーブ)
            Stroke::new(m(0.3, 0.95), m(0.4, 0.7), m(0.5, 0.4), m(0.55, 0.1)),
            // 2b: 下端で右にカーブ
            Stroke::new(m(0.55, 0.1), m(0.7, 0.05), m(0.85, 0.05), m(0.95, 0.12)),
            // 3: 右上の小点
            Stroke::new(m(0.75, 0.95), m(0.8, 0.88), m(0.85, 0.85), m(0.88, 0.82)),
        ],
        '勿' => alloc::vec![
            // 勹 + 三斜
            Stroke::line(m(0.2, 0.85), m(0.7, 0.85)),
            Stroke::new(m(0.7, 0.85), m(0.8, 0.5), m(0.65, 0.2), m(0.45, 0.1)),
            Stroke::new(m(0.45, 0.85), m(0.35, 0.55), m(0.25, 0.3), m(0.15, 0.1)),
            Stroke::new(m(0.55, 0.7), m(0.45, 0.45), m(0.35, 0.25), m(0.25, 0.1)),
            Stroke::new(m(0.65, 0.55), m(0.55, 0.35), m(0.45, 0.2), m(0.35, 0.1)),
        ],
        '少' => alloc::vec![
            Stroke::line(m(0.45, 0.92), m(0.42, 0.5)),
            Stroke::new(m(0.3, 0.7), m(0.25, 0.55), m(0.2, 0.4), m(0.15, 0.3)),
            Stroke::new(m(0.6, 0.7), m(0.7, 0.55), m(0.8, 0.4), m(0.9, 0.3)),
            Stroke::new(m(0.42, 0.5), m(0.35, 0.3), m(0.25, 0.15), m(0.1, 0.05)),
        ],
        '呆' => alloc::vec![
            // 口 + 木
            Stroke::line(m(0.3, 0.95), m(0.7, 0.95)),
            Stroke::line(m(0.7, 0.95), m(0.7, 0.7)),
            Stroke::line(m(0.3, 0.7), m(0.7, 0.7)),
            Stroke::line(m(0.3, 0.95), m(0.3, 0.7)),
            // 木 below
            Stroke::line(m(0.5, 0.7), m(0.5, 0.1)),
            Stroke::line(m(0.1, 0.5), m(0.9, 0.5)),
            Stroke::new(m(0.5, 0.4), m(0.35, 0.3), m(0.2, 0.2), m(0.1, 0.1)),
            Stroke::new(m(0.5, 0.4), m(0.65, 0.3), m(0.8, 0.2), m(0.9, 0.1)),
        ],
        '侖' => alloc::vec![
            // 亼 + 冊
            Stroke::new(m(0.5, 0.95), m(0.3, 0.78), m(0.15, 0.65), m(0.1, 0.6)),
            Stroke::new(m(0.5, 0.95), m(0.7, 0.78), m(0.85, 0.65), m(0.9, 0.6)),
            Stroke::line(m(0.15, 0.6), m(0.85, 0.6)),
            // 冊-like
            Stroke::line(m(0.2, 0.55), m(0.2, 0.1)),
            Stroke::line(m(0.4, 0.55), m(0.4, 0.1)),
            Stroke::line(m(0.6, 0.55), m(0.6, 0.1)),
            Stroke::line(m(0.8, 0.55), m(0.8, 0.1)),
            Stroke::line(m(0.15, 0.35), m(0.85, 0.35)),
            Stroke::line(m(0.1, 0.1), m(0.9, 0.1)),
        ],
