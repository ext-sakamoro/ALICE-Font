...
fn component_strokes(ch: char, b: Bbox) -> Vec<Stroke> {
    ...
    match ch {
        ...
        '朱' => alloc::vec![
            ...
            Stroke::new(m(0.5, 0.5), m(0.35, 0.35), m(0.2, 0.2), m(0.1, 0.1)),
            Stroke::new(m(0.5, 0.5), m(0.65, 0.35), m(0.8, 0.2), m(0.9, 0.1)),
            Stroke::line(m(0.3, 0.8), m(0.7, 0.78)),
        ],
        '弋' => alloc::vec![
            Stroke::line(m(0.15, 0.78), m(0.85, 0.72)),
            Stroke::new(m(0.4, 0.92), m(0.45, 0.65), m(0.5, 0.35), m(0.55, 0.05)),
            Stroke::line(m(0.55, 0.05), m(0.85, 0.1)),
            Stroke::line(m(0.7, 0.92), m(0.78, 0.82)),
        ],
        '勿' => alloc::vec![
            // 勹 + 三斜
